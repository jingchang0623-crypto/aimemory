          ...
          __html: JSON.stringify({
            ...
            "mainEntity": [
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes, AI Memory is completely free for local use. You can upload unlimited conversations, search across all your AI chats, and use the Chrome extension at no cost. All data stays on your device. Plus plan ($3.9/month) adds AI summaries. Pro plan ($7.9/month) adds cloud sync and AI analysis."
                }
              },
              {
                "@type": "Question",
      ...
      "transport": "http"
        ...
        <section id="faq" className="mb-16">
          ...
          <div className="space-y-4">
            {[
              { q: "How much does AI Memory cost?", a: "AI Memory is completely free for local use with unlimited conversations. The Plus plan at $3.9/month adds AI summaries and multi-device access. The Pro plan at $7.9/month adds cloud sync and AI analysis." },
