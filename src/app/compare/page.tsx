...
const competitors = [
  {
    ...
    logo: '🧠',
    highlight: true,
    pricing: 'Free | Plus $6.9/mo | Pro $9.9/mo',
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes, AI Memory\'s core features are completely free with unlimited local storage. The Plus plan ($6.9/month) adds AI summary, stats, and auto-tagging. The Pro plan ($9.9/month) adds unlimited AI analysis, cloud sync with end-to-end encryption, and knowledge graph visualization. All export, search, and memory injection features are free.',
        },
      },
      {
        '@type': 'Question',
