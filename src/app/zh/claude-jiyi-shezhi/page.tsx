...
export const metadata: Metadata = {
  title: 'Claude记忆设置教程 — 让AI记住你的项目信息',
  description: 'Claude怎么设置记忆？详解Claude项目知识功能、与ChatGPT记忆对比，以及如何用AI Memory实现更强大的跨平台记忆。',
  keywords: ['Claude记忆设置', 'Claude项目知识', 'Claude使用技巧', 'Claude记忆功能'],
  alternates: {
    canonical: 'https://aimemory.pro/zh/claude-jiyi-shezhi',
  },
};
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Claude有项目知识功能，但记忆能力有限，但您可以使用AI Memory来保存和管理所有DeepSeek对话记录。',
      },
    },
    {
      '@type': 'Question',
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <article className="prose lg:prose-xl max-w-none">
          ...
          <h1>Claude记忆设置教程 — 让AI记住你的项目信息</h1>
          <p className="text-xl text-gray-600">
            Claude怎么设置记忆？详解Claude项目知识功能、与ChatGPT记忆对比，以及如何用AI Memory实现更强大的跨平台记忆。
          </p>
