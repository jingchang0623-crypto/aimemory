          ...
          <article className="prose prose-invert lg:prose-xl max-w-none">
            ...
            <div className="bg-blue-900/30 border border-blue-800 rounded-lg p-6 my-8">
              ...
              <ul className="text-blue-200 space-y-1">
                ...
                <li><strong>Endpoint:</strong> <code className="text-blue-300">https://aimemory.pro/api/mcp</code> — server name: aimemory-mcp v1.1.0</li>
            ...
            <p>
              ...
              <code className="text-blue-400">aimemory-mcp v1.1.0</code>.
            </p>
