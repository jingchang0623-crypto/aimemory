...
export const BLOG_COUNT = 183; // Actual blog posts in blog-data.ts (verified via grep -c "slug:" = 183)
export const GUIDE_PAGES = 2; // /guides/getting-started, /guides/mcp-quickstart
export const CONTENT_COUNT = BLOG_COUNT + GUIDE_PAGES; // Total "SEO Guides" for homepage (185)
