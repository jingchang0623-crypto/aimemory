...
export const BLOG_COUNT = 211; // Registered blog entries in blog-data.ts (2026-05-24: +ai-memory-vs-chatgpt-memory-2026)
export const GUIDE_PAGES = 2; // /guides/getting-started, /guides/mcp-quickstart
export const CONTENT_COUNT = BLOG_COUNT + GUIDE_PAGES; // Total "SEO Guides" for homepage (211)
