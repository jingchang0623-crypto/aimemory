...
export const BLOG_COUNT = 192; // Actual blog posts in blog-data.ts (updated 2026-05-21: added ai-memory-for-remote-teams-2026)
export const GUIDE_PAGES = 2; // /guides/getting-started, /guides/mcp-quickstart
export const CONTENT_COUNT = BLOG_COUNT + GUIDE_PAGES; // Total "SEO Guides" for homepage (194)
